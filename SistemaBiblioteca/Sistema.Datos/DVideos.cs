...
namespace Sistema.Datos
{
    public class DVideos
    {
        ...
        //Funcion para validar existencia del video en pestania prestamos
        public string Existe_P(string dato, int type)
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("videos_existe_prestamos", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public string Activar(int Id)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("videos_activar", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@id_video", SqlDbType.Int).Value = Id;
                SqlCon.Open();
        ...
        public string Desactivar(int Id)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("videos_desactivar", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@id_video", SqlDbType.Int).Value = Id;
                SqlCon.Open();
